...
import { addGeneric } from "../../../store/actions"
const Transition = React.forwardRef(function Transition(props, ref) {
    return <Slide direction="left" ref={ref} {...props} />;
});

export default function ProductFormModel(props) {
        ...
        <div>
            ...
            >
                <AvForm className="needs-validation">
                    <DialogTitle id="alert-dialog-slide-title">{props.editeData ? "Edit " : "Add"}{" Product Generic"}</DialogTitle>
                    <DialogContent>
