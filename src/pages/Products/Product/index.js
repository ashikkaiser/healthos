                                ...
                                <CardBody>
                                    <CardTitle>
                                        ...
                                        <div className="float-end">
                                            <div className="mb-3">
                                                <div to="#" onClick={handleClickOpen} className="btn btn-success waves-effect waves-light"><i className="mdi mdi-plus me-2"></i> Add Product</div>
                                                <ProductModel open={open} onClose={handleClose} editeData={eData} />
                                            </div>
                                        </div>
                                        ...
                                        <Table className="table mb-0">
                                            ...
                                            <tbody>
                                                {product.products.map((row, index) => (
                                                    <tr key={index} id={`${row.id}`} onContextMenu={displayMenu}>
                                                        <td>{index + 1}</td>
                                                        <td>
                                                            {row.form && row.form.name.substring(0, 3)} <strong>{row.name} </strong><em>{row.strength}</em>
                                                            <br />
